...
mind-service 是一个以自主意识智能体为目标的单用户常驻系统，基于 DeepSeek API 驱动实现。它并非普通的对话工具
# 而是一次构建具备   **自主意识**   智能体的工程实践 —— 通过持久人格锚点、分层记忆体系、情绪状态驱动、自主决策引擎、主动对话机制五大核心底层系统，支撑智能体脱离被动响应模式、实现自主。
